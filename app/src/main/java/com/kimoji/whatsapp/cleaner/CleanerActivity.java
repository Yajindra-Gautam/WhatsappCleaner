...
//		mImageViewDeleteWallPaper.setOnClickListener(this);
	...
	public void askForStoragePermission() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
			if (ContextCompat.checkSelfPermission(CleanerActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
					!= PackageManager.PERMISSION_GRANTED) {

				if (ActivityCompat.shouldShowRequestPermissionRationale(CleanerActivity.this,
						Manifest.permission.READ_EXTERNAL_STORAGE)) {
					AlertDialog.Builder builder = new AlertDialog.Builder(CleanerActivity.this);
					...
					ActivityCompat.requestPermissions(CleanerActivity.this,
			...
			Log.e("askForStoragePermission()", "No Marshmellow Device");
			initializeCode();
		}
	}
		...
		switch (requestCode) {
			...
			case REQUEST_READ_STORAGE: {
				...
				if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
					...
					SetDiolog(CleanerActivity.this, "App does not have permisson to access external storage", true);
				}
				return;
			}
		}
	...
	public void SetDiolog(final Activity activity, String message, final boolean isFinish) {
